...
var KuCoinFutures = /** @class */ (function () {
    function KuCoinFutures(props) {
        ...
        this.futuresMultiCancelOrder = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest({
                        body: params || '',
                        method: constants_1.DELETE,
                        endpoint: resetAPI_1.FUTURES_ORDER_MULTI_CANCEL_EP,
                        callback: callback
                    })];
            });
        }); };
        ...
        this.futuresMaxWithdrawMargin = function (symbol, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol },
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_MAX_WITHDRAW_MARGIN_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresWithdrawMargin = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol, withdrawAmount;
            return __generator(this, function (_a) {
                symbol = params.symbol, withdrawAmount = params.withdrawAmount;
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol, withdrawAmount: withdrawAmount },
                        method: constants_1.POST,
                        endpoint: resetAPI_1.FUTURES_WITHDRAW_MARGIN_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresHistoryPositions = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest({
                        body: params,
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_HISTORY_POSITIONS_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresMaxOpenPositionSize = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol, price, leverage;
            return __generator(this, function (_a) {
                symbol = params.symbol, price = params.price, leverage = params.leverage;
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol, price: price, leverage: leverage },
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_MAX_OPEN_POSITIONS_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresGetMarginMode = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol },
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_GET_MARGIN_MODE_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresChangeMarginMode = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol, marginMode;
            return __generator(this, function (_a) {
                symbol = params.symbol, marginMode = params.marginMode;
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol, marginMode: marginMode },
                        method: constants_1.POST,
                        endpoint: resetAPI_1.FUTURES_CHANGE_MARGIN_MODE_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresGetCrossUserLeverage = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol;
            return __generator(this, function (_a) {
                symbol = params.symbol;
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol },
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_GET_CROSS_LEVERAGE_EP,
                        callback: callback
                    })];
            });
        }); };
        this.futuresChangeCrossUserLeverage = function (params, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            var symbol, leverage;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest({
                        ...
                        method: constants_1.POST,
                        endpoint: resetAPI_1.FUTURES_CHANGE_CROSS_LEVERAGE_EP,
                        callback: callback
                    })];
            });
        }); };
        ...
        this.futuresTradeFees = function (symbol, callback) { return __awaiter(_this_1, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest({
                        body: { symbol: symbol },
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_TRADE_FEE_EP,
                        callback: callback
                    })];
            });
        }); };
        ...
        this.futuresAllTicker = function (callback) { return __awaiter(_this_1, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest({
                        method: constants_1.GET,
                        endpoint: resetAPI_1.FUTURES_ALL_TICKER_TP,
                        callback: callback,
                        isPrivate: false
                    })];
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        wssUri = "".concat(instanceServers[0].endpoint, "?token=").concat(token, "&acceptUserMessage=true&connectId=").concat(websocket_1.CONNECT_ID);
                        websocket = new ws_1.default(wssUri);
                        socketInstance = new websocket_1.WebSocketClient(wssUri, websocket);
    ...
    Object.defineProperty(KuCoinFutures.prototype, "websocket", {
        get: function () {
            ...
            /* === public socket === */
            function klineCandle(symbol, callback) {
                if (callback === void 0) { callback = tools_2.log; }
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, makeSubscribe(symbol, websocket_1.KLINE_CANDLE, callback)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            ...
            function tickerV2(symbols, callback) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, makeSubscribe(symbols, websocket_1.TICKER_V2, callback)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            ...
            function positionAll(callback) {
                if (callback === void 0) { callback = tools_2.log; }
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, _this.futuresSocketSubscribe(websocket_1.POSITION_ALL, callback, true)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            }
            function marginMode(callback) {
                if (callback === void 0) { callback = tools_2.log; }
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, _this.futuresSocketSubscribe(websocket_1.MARGIN_MODE, callback, true)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            }
            function crossLeverage(callback) {
                if (callback === void 0) { callback = tools_2.log; }
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, _this.futuresSocketSubscribe(websocket_1.CROSS_LEVERAGE, callback, true)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
