...
var WebSocketClient = /** @class */ (function () {
    ...
    WebSocketClient.prototype.resubscribe = function () {
        ...
        this.subscriptions.forEach(function (_a) {
            ...
            if (!_this.subscribeMap["".concat(topic, "_").concat(privateChannel)]) {
                _this.socketSend({
                    id: id,
                    type: 'subscribe',
                    topic: topic,
                ...
                _this.subscribeMap["".concat(topic, "_").concat(privateChannel)] = true;
            }
            else {
                console.log("Subscribe Topic:".concat(topic, " privateChannel:").concat(privateChannel, " repeat"));
            }
        });
    };
